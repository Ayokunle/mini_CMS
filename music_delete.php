<html>
	<head>
    	...
    	<script type="text/javascript">
          ...
          $xml = simplexml_load_file('../database/music.xml');

          //Use XPath to find target node for removal
          $uniqueIdToDelete = $_GET['id'];
          $target = $xml->xpath("//track[@id=$uniqueIdToDelete]");
          ...
          $dom->save('../database/music.xml');
          ?>    
          window.location="http://jonnymazmusic.com/admin/music_view.php";
        }else {
          window.location="http://jonnymazmusic.com/admin/music_view.php";
        }
		</script>
